...
const ParkingModule = () => {
  ...
  const questions = [
    {
      question: "Q1: Какой способ парковки наиболее эффективен в условиях ограниченного пространства?",
      answers: {
    ...
    {
      question: "Q3: Как правильно осуществлять обратный ход при парковке задним ходом?",
      answers: {
    ...
    {
      question: "Q4: Какие сигналы поворота обязательны при выезде с парковочного места?",
      answers: {
        A: "Сигнал поворота",
    ...
    {
      question: "Q6: Какое расстояние должно соблюдаться между автомобилями на парковке?",
      answers: {
        A: "Минимум 50 см",
        B: "Минимум 1 метр",
        C: "Минимум 1,5 метра",
    ...
    {
      question: "Q7: Какой из способов парковки является наиболее сложным для водителя?",
      answers: {
        A: "Параллельная парковка",
        B: "Вертикальная парковка",
        C: "Диагональная парковка",
    ...
    {
      question: "Q9: Какая мера безопасности обязательна при парковке на уклонной дороге?",
      answers: {
    ...
    {
      question: "Q10: Какой тип парковки лучше использовать в условиях интенсивного движения?",
      answers: {
        A: "Параллельная парковка",
        B: "Вертикальная парковка",
        C: "Диагональная парковка",
