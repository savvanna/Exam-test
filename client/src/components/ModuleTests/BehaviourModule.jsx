  ...
  const questions = [
    {
      ...
      question: "B1: Если вы едете ночью с включенным дальним светом фар, когда ДОЛЖНЫ переключать их на ближний?",
      answers: {
    ...
    {
      // B3 – без изображения
      question: "B3: Что следует делать, если вам приходится ехать на низкой скорости, что может задерживать другие транспортные средства?",
      answers: {
    ...
    {
      // B4 – без изображения
      question: "B4: Что НЕЛЬЗЯ делать при движении по автомагистрали?",
      answers: {
    ...
    {
      // B6 – без изображения
      question: "B6: Какую рекомендуемую дистанцию следует соблюдать при проезде мимо велосипедиста?",
      answers: {
        A: "1 метр",
        B: "2 метра",
        C: "3 метра",
    ...
    {
      // B8 – без изображения
      question: "B8: Что следует делать при движении в дождливую погоду?",
      answers: {
    ...
    {
      // B9 – без изображения
      question: "B9: Какую стратегию следует применять при движении к нерегулируемому перекрестку?",
      answers: {
    ...
    {
      // B10 – без изображения
      question: "B10: Как поступить, если на дороге неожиданно появляется пешеход?",
      answers: {
        A: "Резко затормозить",
